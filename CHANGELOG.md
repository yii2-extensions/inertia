...
## 0.6.0 September 19, 2026

- feat: add `Inertia::scrollMetadata()` and `Manager::$eventDispatcher`, the PSR-14 dispatcher of the default protocol.

## 0.5.0 September 18, 2026

- build!: require `php-forge/inertia` `^0.5`.

## 0.4.0 September 11, 2026

- feat!: require `php-forge/inertia` `^0.3`, use `Header`, and support portable resolved-page observers.

## 0.3.0 August 25, 2026
